...
`r citet(bib[[c('freedman1963', 'fabius1964', 'ferguson1974')]])`
- `r citet(bib[[c('lavine1992', 'lavine1994')]])` extended to Polya Tree models, completed definitions, and introduced how
...
\end{align*}
\]
- $s_j = 1/1000$ from `r citet(bib[['george1993']])`
...
- `r citet(bib2[['roy2008']])` extended `r citet(bib2[['roy2003']])` to
...
missingness `r citep(bib2[[c('little1994', 'dh2008')]])`
...
In the mixture model , MAR holds `r citep(bib2[[c('molen1998','wang2011')]])` if and only if, for each
$j \geq 2$ and $k < j$:
\[
...
`r citep(bib2[['R']])` package ``qrmissing''.
...
conditional on random effects as in `r citet(bib2[['yuan2010']])`.
